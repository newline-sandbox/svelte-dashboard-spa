<form class="hidden md:block w-60">
  <div
    class="relative h-full w-full focus:ring-indigo-500 focus:border-indigo-500
    shadow-sm sm:text-sm border-gray-300 bg-gray-200 rounded-sm">
    <svg
      width="20"
      height="20"
      viewBox="0 0 20 20"
      ...
      class="absolute transform -translate-y-1/2 top-1/2 left-2 h-auto w-6"
      style="color: #4A5568;">
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
    ...
    <input
      class="h-full block bg-transparent relative left-11 w-44 border-none
      outline-none"
      placeholder="Search" />
  </div>
</form>
